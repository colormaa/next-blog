  ...
  <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
    <div className="flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
      ...
      <div className="flex justify-center self-center  z-10">
        <form  method="post" action="/api/auth/callback/credentials"  className="p-12 bg-white mx-auto rounded-2xl w-100 ">
      <input name="csrfToken" type="hidden" defaultValue={csrfToken} />
            ...
            <div className="space-y-5">
                <div className="space-y-2">
                        ...
                        <input className=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type="text"   name="username" placeholder="mail@gmail.com"/>
                </div>
                <div className="space-y-2">
                    <label htmlFor="password" className="mb-5 text-sm font-medium text-gray-700 tracking-wide">
                        Password
                    </label>
                    <input name="password" className="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type="password" placeholder="Enter your password"/>
                </div>
              ...
              <div className="text-sm">
                <a href="/forgotpassword" className="text-green-400 hover:text-green-500">
